...
namespace BlazorApp1.Shared
{
    public class EnteredUserData
    {
        ...
        [RegularExpression(@"^[a-zA-Z0-9ąćęłńóśźż]*$", ErrorMessage = "LOGIN ZAWIERA NIEDOZWOLONE ZNAKI")]
        public string Login { get; set; } = "";
        [Required(ErrorMessage = "WPROWADŹ HASŁO")]
        [MinLength(5, ErrorMessage = "HASŁO JEST ZBYT KRÓTKIE")]
        [MaxLength(32, ErrorMessage = "HASŁO JEST ZBYT DŁUGIE")]
        [RegularExpression(@"^[a-zA-Z0-9ąćęłńóśźż]*$", ErrorMessage = "HASŁO ZAWIERA NIEDOZWOLONE ZNAKI")]
